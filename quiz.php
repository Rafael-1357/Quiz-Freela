...
<body>
    ...
    <div id="containerQuiz" >
      <div id="quiz" >
        <div id="page1" class="quiz-pages">
          ...
          <button id="page1Button">Iniciar questionário</button>
        </div>
        <div id="page2" class="quiz-pages">
          <div class="perguntas">
            ...
            <div class="botoesPerguntas">
              <button id="page2Next" disabled>Avançar</button>
            </div>
          </div>
        </div>
        <div id="page3" class="quiz-pages">
          <div class="perguntas">
            ...
            <div class="botoesPerguntas">
              ...
              <button id="page3Next" disabled>Avançar</button>
            </div>
          </div>
        </div>
        <div id="page4" class="quiz-pages questoesContainer">
          ...
          <div class="botoesPerguntas botoesPerguntasBD">
            ...
            <button id="page4Next" disabled>Avançar</button>
          </div>
        </div>
        <div id="page5" class="quiz-pages questoesContainer">
          <div class="perguntasBD">
            <div class="titulo">
              <h1>2</h1>
          ...
          <div class="botoesPerguntas botoesPerguntasBD">
            ...
            <button id="page5Next" disabled>Avançar</button>
          </div>
        </div>
        <div id="page6" class="quiz-pages questoesContainer">
          <div class="perguntasBD">
          ...
          <div class="botoesPerguntas botoesPerguntasBD">
            ...
            <button id="page6Next" disabled>Avançar</button>
          </div>
        </div>
        <div id="page7" class="quiz-pages questoesContainer">
          <div class="perguntasBD">
            <div class="titulo multiplo">
              <h1>4</h1>
          ...
          <div class="botoesPerguntas botoesPerguntasBD">
            ...
            <button id="page7Next" disabled>Avançar</button>
          </div>
        </div>
        <div id="page8" class="quiz-pages questoesContainer">
          <div class="perguntasBD">
            <div class="titulo">
              <h1>5</h1>
          ...
          <div class="botoesPerguntas botoesPerguntasBD">
            ...
            <button id="page8Next" disabled>Avançar</button>
          </div>
        </div>
        <div id="page81" class="quiz-pages questoesContainer">
          ...
          <div class="botoesPerguntas botoesPerguntasBD">
            ...
            <button id="page81Next" disabled>Avançar</button>
          </div>
        </div>
        <div id="page9" class="quiz-pages questoesContainer">
          ...
          <div class="botoesPerguntas botoesPerguntasBD">
            ...
            <button id="page9Next" disabled>Avançar</button>
          </div>
        </div>
        <div id="page91" class="quiz-pages questoesContainer">
          ...
          <div class="botoesPerguntas botoesPerguntasBD">
            ...
            <button id="page91Next" disabled>Avançar</button>
          </div>
        </div>
      </div>
      <div id="quiz-imagens">
  ...
  <!-- Scripts -->
  <script src="./scripts/quizPagination.js"></script>
  ...
  <script src="./scripts/raças.js"></script>
</body>
